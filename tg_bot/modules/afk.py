...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} ARE BHAI YE TO GAYA ABHI PATA NAI KAB AAYEGE!".format(update.effective_user.first_name))
    ...
    if message.entities and entities:
        for ent in entities:
            ...
            if sql.is_afk(user_id):
                ...
                if valid:
                    if not reason:
                        res = "{} ABHI ME DUR JA RHA MOBAIL CHORKE!".format(fst_name)
                    else:
                        res = "{} MOBAILE MERE PASS NAI HE UNGLI MAT KRO!\nReason:\n{}".format(fst_name, reason)
